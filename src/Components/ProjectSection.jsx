...
const ProjectSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-screen px-[6vw] py-[6vh]">
        <div className="absolute top-0 left-0 w-full h-full z-0 pointer-events-none">
            <div className="sticky top-4 lg:top-8 w-screen h-screen overflow-hidden">
                <div 
                    ref={horizontalRef} 
                ...
                >
                    {PROJECTS.map((proj, index) => (
                        <div key={`preview-${proj.id}`} className="w-screen h-screen flex items-center justify-end bg-transparent">
                            <div className="w-[94vw] h-[86vh] ml-[6vw] mr-[6vw] rounded-2xl border-2 backdrop-blur-sm flex items-center justify-center shadow-sm pointer-events-auto">
        ...
        <div className="relative z-10 w-full h-full pointer-events-none">
            ...
            {PROJECTS.map((proj, index) => (
                <div key={`text-${proj.id}`} className="w-full h-screen flex flex-col items-center justify-center  bg-transparent pointer-events-none">
                    <div className="w-fit pointer-events-auto">
                        
                        <h2 className="fredoka lg:w-[50vw] text-center mb-6 tracking-tighter">
                            {proj.title}
                        </h2>
